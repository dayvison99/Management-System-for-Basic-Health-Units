 ...
 * @author dayvison
 */
public class TelaTecEnfermagemListagem extends javax.swing.JInternalFrame {
    
    TecEnfermagemRepositorio dao = GerenciadorReferencias.getTecEnfermagem();
    
    TelaTecEnfermagemEditar editar;

    /**
     * Creates new form TelaTecEnfermagemListagem
     */
    public TelaTecEnfermagemListagem() {
        initComponents();
        
        List<TecEnfermagem>busca = dao.Buscar(null);
        
        preencheTabela(busca);
    }

        private void preencheTabela(List<TecEnfermagem>lista){
        DefaultTableModel modelo = new DefaultTableModel();
        modelo.addColumn("ID");
        modelo.addColumn("Nome");
        
        for(TecEnfermagem t : lista){
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Consulta Téc Enfermagem");
        setToolTipText("");
    ...
    private void tblBuscaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblBuscaMouseClicked
        ...
        editarTecEnfermagem(id);
    }//GEN-LAST:event_tblBuscaMouseClicked

      public void editarTecEnfermagem(int id){
        ...
        editar = new TelaTecEnfermagemEditar();

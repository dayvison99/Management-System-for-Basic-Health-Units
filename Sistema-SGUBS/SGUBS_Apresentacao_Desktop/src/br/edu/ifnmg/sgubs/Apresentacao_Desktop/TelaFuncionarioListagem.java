 ...
 * @author dayvison
 */
public class TelaFuncionarioListagem extends javax.swing.JInternalFrame {

   FuncionarioRepositorio dao =GerenciadorReferencias.getFuncionario();
    
    TelaFuncionarioEditar editar;
    /**
     * Creates new form TelaFuncionarioListagem
     */
    public TelaFuncionarioListagem() {
        initComponents();
     ...
     public void buscar(String nome){
        ...
        Funcionario filtro = new Funcionario(0, nome, null, null,null,0, 0, null, null);
    ...
    public void editarFuncionario(int id){
        ...
        editar = new TelaFuncionarioEditar();
